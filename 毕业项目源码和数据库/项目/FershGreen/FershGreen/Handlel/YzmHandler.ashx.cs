...
namespace FershGreen.Handlel
{
    /// <summary>
    /// YzmHandler 的摘要说明
    /// </summary>
    public class YzmHandler : IHttpHandler,IRequiresSessionState
    {
        /// <summary>
        /// 主体方法用来生成验证码
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //写入画布的字体
            Font font = new Font("幼圆", 26);
            //定义画笔,设置画笔颜色
            Brush brush1 = new SolidBrush(color[random.Next(0, color.Length - 1)]);
            graphics.DrawString(((char)charNum1).ToString(), font, brush1, 5, 2);
